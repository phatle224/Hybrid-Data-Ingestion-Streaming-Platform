  ...
  create view "insuranceWarehouse"."staging"."stg_contract_objects_vehicle__dbt_tmp"
    
    
  as (
    WITH source AS (
    SELECT * FROM "insuranceWarehouse"."staging"."stgInsuranceContractObjectVehicle"
),
