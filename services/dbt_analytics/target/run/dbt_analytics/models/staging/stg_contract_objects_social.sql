  ...
  create view "insuranceWarehouse"."staging"."stg_contract_objects_social__dbt_tmp"
    
    
  as (
    WITH source AS (
    SELECT * FROM "insuranceWarehouse"."staging"."stgInsuranceContractObjectSocialInsurance"
),
