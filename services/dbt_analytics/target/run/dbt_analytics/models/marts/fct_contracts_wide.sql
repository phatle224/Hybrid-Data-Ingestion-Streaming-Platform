  ...
  create  table "insuranceStaging"."reporting"."fct_contracts_wide__dbt_tmp"
  ...
  (
    WITH contracts AS (
    SELECT * FROM "insuranceStaging"."staging"."stg_contracts"
),

objects AS (
    SELECT * FROM "insuranceStaging"."intermediate"."int_contracts_deduped"
),
