  ...
  create  table "insuranceStaging"."reporting"."dm_profiling_analysis__dbt_tmp"
  ...
  (
    WITH contracts AS (
    SELECT * FROM "insuranceStaging"."reporting"."fct_contracts_wide"
),

customers AS (
    SELECT * FROM "insuranceStaging"."reporting"."dim_customers"
),

claims AS (
    SELECT * FROM "insuranceStaging"."staging"."stg_claims"
),
